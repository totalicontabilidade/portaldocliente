...
(function (global) {
  ...
  function telaChecklist(r) {
    ...
    Promise.all([Dados.checklist(empresa.id, anoMes), Dados.checklists(empresa.id)]).then(function (res) {
      ...
      var html = '<div class="pagina"><div class="cabecalho"><div><div class="cabecalho__kicker">' + U.esc(nomeMes(anoMes)) + '</div><h1>Envio do mês</h1><p>É o que a Totali precisa receber de você todo mês para fechar a contabilidade da empresa: extratos, notas, comprovantes. Toque em <b>Anexar</b> no item e envie o arquivo; o item fica marcado sozinho. A Totali confere e dá o aceite.</p></div>' +
