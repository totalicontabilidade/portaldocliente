...
(function (global) {
  ...
  function previaArte(url) {
    ...
    return '<div class="imagem-banner__quadro"><img src="' + u + '" alt=""><span class="imagem-banner__guia" aria-hidden="true"></span></div>' +
      ...
      function editor(c) {
        ...
        setTimeout(function () {
          ...
          if (inp) inp.addEventListener("change", function () {
            ...
            reduzirImagem(f, 1600).then(function (blob) { novaImagem = blob; tirarImagem = false; box.innerHTML = previaArte(URL.createObjectURL(blob)); UI.toast("Imagem pronta (" + Math.round(blob.size / 1024) + " KB). Confira a prévia e salve para publicar.", "ok"); }).catch(function () { UI.toast("Não consegui ler essa imagem.", "erro"); });
          });
