...
var SHELL = ["./", "./index.html", "./equipe.html", "./anterior.html", "./extratos.html", "./css/tokens.css", "./css/app.css", "./assets/fonts/manrope-variable.woff2",
  ...
  "./assets/brand/calc-menu.svg", "./assets/brand/calc-login.svg", "./assets/brand/calc-piece.svg", "./assets/brand/logo-escuro.png", "./assets/brand/logo-claro.png", "./assets/brand/simbolo.png", "./assets/icon-192.png", "./assets/favicon-32.png", "./manifest.webmanifest"];
